...
/**
 * The Gift class represents gift objects. Gifts can have a name, price, targeted gender, minimum and maximum age,
 * and interest categories the gift is associated with (e.g. sports, games, etc). Each gift can be categorized under
 * 1 to 3 different interests. The rateGift method can be called to rate the quality of a gift for a specific 
...
public class Gift {
	 ...
	 * @param minAge the minimum age of a possible recipient of this gift
	 * @param maxAge the maximum age of a possible recipient of this gift
	 ...
	 */
	public Gift (String name, int minAge, int maxAge, int price, char gender, Interest giftCategory) {
		this.name = name;
		this.minAge = minAge;
		this.maxAge = maxAge;
		this.price = price;
	 ...
	 */
	public Gift (String name, int minAge, int maxAge, int price, char gender, 
			Interest giftCategory1, Interest giftCategory2) {
		this.name = name;
		this.minAge = minAge;
		this.maxAge = maxAge;
		this.price = price;
	 ...
	 */
	public Gift (String name, int minAge, int maxAge, int price, char gender, 
			Interest giftCategory1, Interest giftCategory2, Interest giftCategory3) {
		this.name = name;
		this.minAge = minAge;
		this.maxAge = maxAge;
		this.price = price;
